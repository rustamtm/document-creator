...
class TranslationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Translate = channel.unary_unary(
                '/doccreator.TranslationService/Translate',
...
def add_TranslationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'doccreator.TranslationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('doccreator.TranslationService', rpc_method_handlers)
