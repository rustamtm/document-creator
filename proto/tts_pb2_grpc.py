...
class TTSServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Synthesize = channel.unary_unary(
                '/doccreator.TTSService/Synthesize',
...
def add_TTSServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'doccreator.TTSService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('doccreator.TTSService', rpc_method_handlers)
